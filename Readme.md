...
Due to the current unavailability of quantum hardware, the quantum algorithm described in the paper was implemented using classical simulation in the experimental validation. The simulation achieves an error consistent with the theoretical analysis of the quantum algorithm, and all conclusions presented in the paper remain valid. For questions or feedback, please contact the project developers.
