...
def GeneralAnsatzGES(A, B, layerAnsatzs, isPrintScreen = True, DifferentStep = 1e-6, LearnRateVector = [1], \
                     ...
                     initialAnsatzsNum = 1000, useNoise = True, SingleGateNoise = 1e-6, DoubleGateNoise = 1e-8, usePSR = True, isPrintcfg = False):
...
def VQGES(A, B, layerAnsatzs = 6, isPrintScreen = True, isOutputOriginIR = True, isOutputAnsatzCircuit = True, InitialAnsatzOffsetRate = 0.1, DifferentStep = 1e-7, LearnRateVector = [1], \
                     LearnRateTrainSize = 5, LearnRateTrainOffset = 1.0, MaxIterStep = 0, LossMonitor = 1e-5, isOutputLoss = True,\
                     initialAnsatzsNum = 1000, useNoise = False, SingleGateNoise = 0.01, DoubleGateNoise = 0.03, usePSR = True, isPrintcfg = False, isUseOptimizeMethod = True):
    """
